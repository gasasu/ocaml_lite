...
and ast_binding = Letbinding of string * ast_param list * ast_type_expr  * ast_expr
| Letrecbinding of string * ast_param list * ast_type_expr * ast_expr
| Typebinding of string * (string * ast_type_expr ) list

and ast_param = SingleParam of string
| TypedParam of string * ast_type_expr

and ast_expr = 
| Letexpr of (string * ast_param list * ast_type_expr  * ast_expr * ast_expr)
| Letrec of (string * ast_param list * ast_type_expr  * ast_expr * ast_expr)
| Ifexpr of (ast_expr * ast_expr * ast_expr)
| Funcexpr of (ast_param list * ast_type_expr * ast_expr)
...
and ast_match_branch = Branch of (string * ast_pattern_vars list * ast_expr)
